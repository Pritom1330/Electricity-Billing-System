    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(rs.next()){
                t1.append("---------------------------------------------------------------");
                t1.append("\n\n");
                t1.append("\n Cost per Unit:             BDT "+rs.getString("cost_per_unit"));
                t1.append("\n Meter Rent:                BDT "+rs.getString("meter_rent"));
                t1.append("\n Service Charge:            BDT "+rs.getString("service_charge"));
                t1.append("\n Service Tax:               BTD "+rs.getString("service_tax"));
                t1.append("\n Swacch Bharat Cess:        BDT "+rs.getString("swacch_bharat_cess"));
                t1.append("\n Fixed Tax:                 BDT "+rs.getString("fixed_tax"));
                t1.append("\n");
