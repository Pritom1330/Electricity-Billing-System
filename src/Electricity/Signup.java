...
public class Signup extends JFrame implements ActionListener{
    ...
    // Admin account creation logic remains unchanged
    str = "insert into login values('"+meter_no+"', '"+username+"', '"+name+"', '"+password+"', '"+user+"')";
} else {
    // Customer account creation logic
    str = "insert into login (username, name, password, user, meter_no) values ('"+username+"', '"+name+"', '"+password+"', '"+user+"', '"+meter_no+"')";
}
